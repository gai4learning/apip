...
- [CUHK Azure OpenAI API Documentation](https://cuhk-apip.developer.azure-api.net/)
...
- [Best Practices for API Usage](https://platform.openai.com/docs/guides/rate-limits/best-practices)
